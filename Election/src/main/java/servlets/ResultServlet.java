...
public class ResultServlet extends HttpServlet{
	...
	protected void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		...
		for(Candidate c : list)
		{
			...
			out.printf("<td>%s</td>\n", c.getParty());
			out.printf("<td>%d</td>\n", c.getVotes());
			out.printf("<td><a href='editcand?id=%d'><img width='24' height='24' src='E:\\java_adv_prac\\Election\\src\\main\\webapp\\edit.png\'/></a> <a href='delcand?id=%d'><img width='24' height='24' src='E:\\java_adv_prac\\Election\\src\\main\\webapp\\delete.png\'/></a></td>\n", c.getId(), c.getId());
			out.printf("</tr>");
		}
		out.printf("</tbody>");
		out.printf("</table>");
